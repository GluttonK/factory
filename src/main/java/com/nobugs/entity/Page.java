...
public class Page<T> {  
    ...
    public com.nobugs.entity.Page<T> setOrderField(String orderField) {
	...
	public com.nobugs.entity.Page<T> setOrderDirection(String orderDirection) {
    ...
    public com.nobugs.entity.Page<T> setPageNo(int pageNo) {
       this.pageNo = pageNo;  
       return this;
    }  
    ...
    public com.nobugs.entity.Page<T> setPageSize(int pageSize) {
    ...
    public com.nobugs.entity.Page<? extends T> setResults(List<? extends T> results) {
    ...
    public com.nobugs.entity.Page<T> setParams(Map<String, Object> params) {
       this.params = params;
       return this;
    }  
